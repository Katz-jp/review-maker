...
const faqItems = [
  ...
  {
    q: "お客様に何をお願いすればいいですか？",
    a: "店頭やLINEなどで「簡単なアンケートに答えると、投稿用の文章が作れます。投稿前に内容確認してください」と案内するだけでOKです。QRコードやリンクを渡す運用が最もスムーズです。",
  },
  {
    q: "低評価やネガティブな口コミにも対応できますか？",
    a: "返信ヘルパーで、落ち着いたトーンの返信案を提案できます。謝意・事実確認・改善意志・再発防止・来店導線などを自然に含めた形に整えられます。",
  },
  {
    q: "月に何件くらい口コミが増えますか？",
    a: "増加数は来店数や声かけの頻度によって変わります。ポイントは「お願いする」より「投稿の手間を減らす導線」を作ることです。QR設置＋会計時の一言＋LINE送付など、1つのルーティンにすると継続しやすくなります。",
  },
  {
    q: "返信文は、毎回同じ文になりませんか？",
    a: "トーンの切り替えや、口コミ内容に合わせた具体への言及を入れることで、コピペ感を減らせます。店名や担当名、予約導線などの定型フレーズも必要に応じて差し込めます。",
  },
  {
    q: "どのくらい手間が減りますか？",
  ...
  },
  {
    ...
    a: "運用方針として、個人が特定される情報は入力しないようご案内ください。",
  },
];
