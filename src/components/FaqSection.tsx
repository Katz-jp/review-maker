...
const faqItems: FaqItem[] = [
  ...
  {
    q: "アンケートの選択肢は変えられますか？",
    a: "はい。管理画面から各設問にオリジナルの選択肢を最大3つまで追加できます。医院の特色や強みに合わせてカスタマイズしていただくと、より貴院らしい口コミ文が生成されます。",
  },
  {
    q: "料金はいくらですか？",
  ...
  },
  {
    ...
    a: (
      <>
        クレジットカード払いに対応しています。決済には世界的に信用のある
        <a
        ...
        を利用しており、カード情報は決済代行会社によって安全に管理されるため、当方がカード番号などを直接知ることは一切ございません。請求書払いをご希望の方は、お問い合わせフォームより別途ご相談ください。
      </>
    ),
  },
  {
