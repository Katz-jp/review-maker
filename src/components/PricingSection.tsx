...
export default function PricingSection() {
  return (
    <section
      id="pricing"
      className="px-4 sm:px-6 py-12 sm:py-16 bg-green-50 border-y border-green-100 scroll-mt-16"
    >
      <div className="max-w-5xl mx-auto">
        <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 text-center mb-6 pb-3 border-b-2 border-primary/50">
          Review Maker Pro 月額 9,980円
        </h2>
        <h2 className="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-3 leading-snug">
          <span className="block">
            🎉 30医院限定！先行導入キャンペーン実施中 🎊
          </span>
          <span className="block mt-3 text-green-600">初月無料＋２ヶ月目・３ヶ月目は半額！</span>
        </h2>
          ...
          {phases.map((phase) => (
            ...
            >
              ...
              <div className={`text-center ${phase.isUpcoming ? "text-gray-500" : ""}`}>
                ...
                {phase.isCurrent && (
                  <p className="mt-3 text-center text-base font-bold text-amber-700 border-l-4 border-amber-500 pl-3 py-1.5">
                ...
                {phase.isCurrent && (
                  <Link
                    ...
                    className="mt-4 inline-block w-full px-5 py-3 rounded-xl bg-primary hover:bg-primary-dark text-gray-900 font-bold text-base text-center transition-colors shadow-md hover:shadow-lg"
                  >
                    30日間無料ではじめてみる！
                  </Link>
                )}
